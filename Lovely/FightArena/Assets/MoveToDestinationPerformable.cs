...
public class MoveToDestinationPerformable : Performable
{
    ...
    public MoveToDestinationPerformable(Mind performer, Action<bool> callBack, Vector3 destination, bool acceptClosestLocation = false, float stoppingDistance = 1f, bool isUrgent = true)
    {
