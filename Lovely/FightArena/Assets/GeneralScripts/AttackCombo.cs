...
public partial class AttackCombo : Ability
{
    ...
    {
        new AttackInfo(punchLowAnimation, false, HitBoxType.HandR, knockBackModerateAnimation, -5f),
        new AttackInfo(punchMidAnimation, false, HitBoxType.HandR, knockBackLightAnimation, -4f),
        new AttackInfo(punchHighAnimation, true, HitBoxType.HandL, knockBackHeavyAnimation, -6f),
    };
