...
namespace UnityEditor.AI
{
    ...
    [CustomEditor(typeof(NavMeshSurfaceOther))]
    class NavMeshSurfaceOtherEditor : Editor
    {
        ...
        {
            public NavMeshSurfaceOther surface;
        ...
        static string GetAndEnsureTargetPath(NavMeshSurfaceOther surface)
        {
        ...
        static void CreateNavMeshAsset(NavMeshSurfaceOther surface)
        {
        ...
        static NavMeshData GetNavMeshAssetToDelete(NavMeshSurfaceOther navSurface)
        {
            var prefabType = PrefabUtility.GetPrefabType(navSurface);
            if (prefabType == PrefabType.PrefabInstance || prefabType == PrefabType.DisconnectedPrefabInstance)
            {
                // Don't allow deleting the asset belonging to the prefab parent
                var parentSurface = PrefabUtility.GetCorrespondingObjectFromSource(navSurface) as NavMeshSurfaceOther;
        ...
        void ClearSurface(NavMeshSurfaceOther navSurface)
        {
        ...
        Bounds GetBounds()
        {
            var navSurface = (NavMeshSurfaceOther)target;
        ...
        public override void OnInspectorGUI()
        {
            ...
            foreach (NavMeshSurfaceOther navSurface in targets)
            {
            ...
            using (new EditorGUI.DisabledScope(Application.isPlaying || m_AgentTypeID.intValue == -1))
            {
                ...
                {
                    foreach (NavMeshSurfaceOther s in targets)
                        ClearSurface(s);
                ...
                if (GUILayout.Button("Bake"))
                {
                    ...
                    foreach (NavMeshSurfaceOther surf in targets)
                    {
        ...
        static NavMeshData InitializeBakeData(NavMeshSurfaceOther surface)
        {
        ...
        static void RenderBoxGizmoSelected(NavMeshSurfaceOther navSurface, GizmoType gizmoType)
        {
            RenderBoxGizmo(navSurface, gizmoType, true);
        }

        [DrawGizmo(GizmoType.NotInSelectionHierarchy | GizmoType.Pickable)]
        static void RenderBoxGizmoNotSelected(NavMeshSurfaceOther navSurface, GizmoType gizmoType)
        {
        ...
        static void RenderBoxGizmo(NavMeshSurfaceOther navSurface, GizmoType gizmoType, bool selected)
        {
        ...
        public static void CreateNavMeshSurface(MenuCommand menuCommand)
        {
            ...
            go.AddComponent<NavMeshSurfaceOther>();
