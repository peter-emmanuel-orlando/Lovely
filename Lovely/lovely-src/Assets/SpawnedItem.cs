...
public abstract class SpawnedItem<TItem> : ItemsProvider, ISpawnedItem<TItem> where TItem : Item, new()
{
    private readonly Type[] itemTypes = new Type[] { new TItem().ItemType };
