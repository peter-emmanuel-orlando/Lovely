...
public class PlayerControl : IPerformable, IDecisionMaker
{
    ...
    public float DeltaWakefulness { get { return _deltaWakefulness; } }//decreases when awake, depletes quicker when performing taxing tasks, increases 1.5x speed when sleeping
    public float DeltaExcitement { get { return _deltaExcitement; } }//depletes awake or asleep. Tedious work takes chunks from this. relaxation activities increase this
    public float DeltaSpirituality { get { return _deltaSpirituality; } }//depletes awake or asleep. relaxation activities increase this. Tedious Work or seedy activities takes chunks from this
    public float DeltaSocialization { get { return _deltaSocialization; } }//depletes when awake. increases when working or playing together
    public float DeltaCalories { get { return _deltaCalories; } }//num days calories will last.
    public float DeltaBlood { get { return _deltaBlood; } }//reaching 0 blood and being passes out
    public bool IsSleepActivity { get { return _isSleepActivity; } }//is this activity sleeping?
    ...
    public ActivityState ActivityType { get { return ActivityState.Work; } }
    ...
    public bool IsPerforming { get { return true; } }
